...
const POLAR_PLANS: Record<string, { planType: string; amount: number }> = {
    'bookmarx_monthly': { planType: 'monthly', amount: 500 },    // $5.00
    'bookmarx_yearly': { planType: 'yearly', amount: 5000 },     // $50.00
    'bookmarx_lifetime': { planType: 'lifetime', amount: 10000 } // $100.00
};
    ...
    try {
        ...
        switch (eventType) {
            ...
            case 'order.created': {
                ...
                if (productId !== 'bookmarx_lifetime') {
